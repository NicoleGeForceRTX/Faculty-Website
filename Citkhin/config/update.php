...
include "./connect.php";
$result_id = $_GET['id'];
$employee = $pdo -> query("SELECT * FROM `employees_data` WHERE `id`='$result_id'")-> fetchAll()[0];
?>
...
<div class="title__container">
    <h4>Update data about employee</h4>
</div>
<form class="form__container" action="../database/update_data.php" method="post">
    <input type="hidden" name="id" value="<?= $result_id ?>">
    <label>
        <p>Full name</p>
        <input type="text" name="full_name" value="<?= $employee[0]['full_name'] ?>">
    </label>
    <label>
        <p>Positions held</p>
        <textarea name="positions_held"><?php echo $employee[0]['positions_held'] ?></textarea>
    </label>
    <br>
    ...
    <div class="container footer__container">
        ...
        <div class="footer__2">
            ...
            <ul class="permalinks">
                <li><a href="../index.php">Home</a></li>
                <li><a href="../about.php">About</a></li>
                <li><a href="../my_group.html">Courses</a></li>
                <li><a href="../contact.php">Contact</a></li>
            </ul>
        </div>
