...
include "./connect.php";
$result_id = $_GET['id'];
$employee = $pdo -> query("SELECT * FROM `employees_contacts` WHERE `id`='$result_id'")-> fetchAll()[0];
?>
...
<div class="title__container">
    <h4>Update employee contact</h4>
</div>
<form class="form__container" action="../database/update_data_tb2.php" method="post">
    <input type="hidden" name="id" value="<?= $result_id ?>">
    <label>
        <p>Number</p>
        <textarea name="number"><?php echo $employee[0]['number'] ?></textarea>
    </label>
    <br>
